...
<head>
    ...
    <title>Azany B2B Order Cancellation Confirmation</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p></p>
        <h2>Order {{ $orderedItems['order_number'] }} Has been Cancelled by the Seller.</h2>
        <p class="subtitle">Your #1 Global E-commerce Platform</p>

        <div class="message">
            <p>
               This is to inform you that your order {{ $orderedItems['order_number'] }} from {{ config('app.name') }} has been
                cancelled.
