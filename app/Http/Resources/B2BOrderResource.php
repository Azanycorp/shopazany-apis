...
class B2BOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'seller_unit_price' => (string) $this->resource->seller_unit_price,
            'buyer_unit_price' => (string) $this->resource->buyer_unit_price,
            'buyer_total_amount' => (string) $this->resource->buyer_total_amount,
            'seller_total_amount' => (string) $this->resource->seller_total_amount,
