    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'business_info' => (object) [
                'shop_name' => (string) $this->resource->company_name,
                ...
                'business_logo' => $this->resource->userbusinessinfo?->business_logo,
                'business_banner' => $this->resource->userbusinessinfo?->business_banner,
                'min_order_amount' => $this->resource->userbusinessinfo?->min_order_amount,
                'opening_time' => $this->resource->userbusinessinfo?->opening_time,
                'closing_time' => $this->resource->userbusinessinfo?->closing_time,
                'estimated_delivery_days' => $this->resource->userbusinessinfo?->estimated_delivery_days,
                'order_prefix' => $this->resource->userbusinessinfo?->order_prefix,
                'description' => $this->resource->userbusinessinfo?->description,
            ],
